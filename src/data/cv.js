export const cv = {
  ...
  projects: [
    ...
    {
      title: 'ClientIP',
      description: 'Client IP detector and various IP validators for PHP.',
      type: 'composer',
      highlighted: true,
      license: 'MIT',
      repo: 'https://github.com/DimChtz/ClientIP',
      packageUrl: 'https://packagist.org/packages/dimchtz/clientip',
      packageLabel: 'Packagist',
      installCommand: 'composer require dimchtz/clientip',
      tech: ['PHP', 'Composer'],
      highlights: ['Detect visitor IP from headers', 'External IP detection', 'IPv4/IPv6 validation'],
    },
    {
      title: 'rust-fstream',
      description: 'A simple library to read/write files more easily in Rust.',
      type: 'rust',
      highlighted: true,
      license: 'MIT',
      repo: 'https://github.com/DimChtz/rust-fstream',
      packageUrl: 'https://crates.io/crates/fstream',
      packageLabel: 'crates.io',
      installCommand: 'cargo add fstream',
      tech: ['Rust'],
      highlights: ['read_text, write_text, read_lines, write_lines', 'read_words, read_delim, merge'],
    },
    {
      title: 'dimchatzis.com',
      description: 'Terminal-inspired CV site built with Vue 3 and Vite. Type commands in a fake terminal, play games, use dev tools, and scroll to a classic CV layout.',
      type: 'web',
      highlighted: true,
      license: 'MIT',
      repo: 'https://github.com/DimChtz/dimchatzis.com',
      tech: ['Vue 3', 'Vite', 'JavaScript'],
      highlights: ['Interactive terminal with commands', 'Games (Snake, Build Something)', 'Dev tools (calculator, notepad, QR, etc.)', 'Print-friendly CV layout'],
    },
  ],
  research: {
