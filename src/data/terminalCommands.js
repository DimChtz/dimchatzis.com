export const HELP_TEXT = [
  ...
  '  css            — 🎛️  CSS variables playground (tweak theme live)',
  '  inspect        — 🔍 DOM inspector (DevTools-style overlay)',
...
export const TAB_COMMANDS = [
  ...
  'duck', 'whoami', 'version', 'date', 'fortune', 'neofetch', 'ls', 'echo ', 'wget ', 'coffee', 'clear', 'weather', 'theme', 'theme light', 'theme dark', 'css', 'inspect',
...
export const COMMANDS = [
  ...
  { name: 'css', aliases: ['css', 'css vars', 'variables'], path: '/apps/css-playground', helpLine: '  css            — 🎛️  CSS variables playground (tweak theme live)' },
  { name: 'inspect', aliases: ['inspect', 'inspector', 'dom'], path: '/usr/bin/inspect', helpLine: '  inspect        — 🔍 DOM inspector (DevTools-style overlay)' },
...
export const MAN_PAGES = {
  ...
  'css': ['NAME', '       css - CSS variables playground', '', 'SYNOPSIS', '       css', '       css vars', '       variables', '', 'DESCRIPTION', '       Opens a panel to tweak theme CSS variables in real time.', '       Changes apply to the whole site. Copy the generated CSS when done.', ''],
  'inspect': ['NAME', '       inspect - DOM inspector', '', 'SYNOPSIS', '       inspect', '       inspector', '       dom', '', 'DESCRIPTION', '       Toggles DevTools-style DOM inspector. When on, hover elements to see', '       their selector, dimensions, and computed styles. Use the 🔍 button to toggle.', ''],
